...
from main import process_voice_commands
# Set the web folder and initial HTML file
eel.init('web')  # Initialize the eel module with the 'DESIGN' directory
@eel.expose
...
os.system('firefox --kiosk http://localhost:8000/index.html')
